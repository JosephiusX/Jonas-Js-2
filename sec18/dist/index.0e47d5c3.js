...
const showRecipe = async function() {
    try {
        const res = await fetch(`https://forkify-api.herokuapp.com/api/v2/recipes/5ed6604691c37cdc054bd0c0`); // fetch creates a promise so it must be awaited
